            ...
            <div class="row">
                <div class="col-lg-4 pb-5">
                    ...
                    <div class="author-card pb-3">
                        <div class="author-card-cover" style="background-image: url(<c:url value="https://bootdey.com/img/Content/flores-amarillas-wallpaper.jpeg"/>);"><a class="btn btn-style-1 btn-white btn-sm" href="#" data-toggle="tooltip" title="" data-original-title="You currently have 290 Reward points to spend"><i class="fa fa-award text-md"></i>&nbsp;290 points</a></div>

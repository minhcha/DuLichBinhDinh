...
<div class="main-content">
	<form action="<c:url value='/quan-tri/hoa_don/danh-sach'/>" id="formSubmit" method="get">
							...
							<div class="table-btn-controls">
								<div class="pull-right tableTools-container">
									<div class="dt-buttons btn-overlap btn-group">
										<c:url var="createNewURL" value="/quan-tri/hoa-don/chinh-sua"/>
										<a flag="info"
									...
									<table class="table table-bordered">
										...
										<c:forEach var="item" items="${model}">
											<tr>
												...
												<td>${item.endDate}</td>
												<td>${item.sumPrice}</td>
												<td>${item.billExpired}</td>
												<td>
													<c:url var="updateNewURL" value="/quan-tri/hoa-don/chinh-sua">
